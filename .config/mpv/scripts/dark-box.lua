...
local user_opts = {
    ...
    valign = 0.97,               -- vertical alignment, -1 (top) to 1 (bottom)
    ...
    fadeduration = 120,         -- duration of fade out in ms, 0 = no fade
	...
	font = "Fira Sans Book",	-- default osc font
...
local osc_styles = {
    s24Button = "{\\blur0\\bord0\\1c&HB8499A8\\3c&HFFFFFF\\fs24\\fnmpv-osd-symbols}",
    s16Button = "{\\blur0\\bord0\\1c&H8499A8\\3c&HFFFFFF\\fs16\\fn" .. user_opts.font .. "}",
    cyButton = "{\\blur0\\bord0\\1c&H8499A8\\3c&HFFFFFF\\fs20\\fnmpv-osd-symbols}",
    cyDigit = "{\\fn" .. user_opts.font .. "}",
    divA = "{\\blur0\\bord0\\1c&H282828\\3c&HFFFFFF\\fs16\\fnmpv-osd-symbols}",
    divB = "{\\blur0\\bord0\\1c&H4E5157\\3c&HFFFFFF\\fs16\\fnmpv-osd-symbols}",
    bgBox = "{\\rDefault\\blur0\\bord0\\1c&H21201D\\3c&H6A9D68}",	
    fgSeekbar = "{\\blur0\\bord0\\1c&H6A9D68\\3c&HFFFFFF\\fs13}",
    tpSeekbar = "{\\blur2\\bord".. user_opts.tooltipborder .."\\1c&HB2DBEB\\3c&H000000\\fs18}",
    bgSeekbar = "{\\blur0\\bord0\\1c&H36383C\\3c&HFFFFFF\\fs13\\q2}",

    wcButtons = "{\\1c&H6A9D68\\fs24\\fnmpv-osd-symbols}",
    wcTitle = "{\\1c&Hb2dbeb\\fs16\\q2}",
    wcBar = "{\\1c&H2f3032}",
	
    elementDown = "{\\1c&H545c66}",
}
...
layouts["default"] = function ()
    ...
    -- Seekbar
    --
	geo ={x = refX + osc_geo.w/2 , y = refY + 20 , an = 5, w = osc_geo.w - 20, h = 20}
...
--    local subMarginY = oscVisible and (65+defMarginY) or defMarginY
